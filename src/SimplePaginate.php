...
class SimplePaginate
{
  ...
  public function getLinks(): string
  {
    ...
    if ($this->total_pages > 1)
    {
      ...
      if ($this->current_page > 1)
      {
        $links .= '<li class="' . $this->li_class . '"><a class="' . $this->a_class . '" href="' . $this->canonical_url . '?page=' . $this->previous_page . $this->noHTML($this->url_params) . $this->anchor . '">&lt;</a></li>';
        $links .= '<li class="' . $this->li_class . '"><a class="' . $this->a_class . '" href="' . $this->canonical_url . '?page=1' . $this->noHTML($this->url_params) . $this->anchor . '">&lt;&lt;</a></li>';
      }
      ...
      for ($i = $this->start; $i <= $this->end; $i++)
      {
        ...
        {
          $links .= '<li class="' . $this->li_class . '"><a class="' . $this->a_class . '" href="' . $this->canonical_url . '?page=' . $i . $this->noHTML($this->url_params) . $this->anchor . '">' . $i . '</a></li>';
        }
      }
      ...
      {
        $links .= '<li class="' . $this->li_class . '"><a class="' . $this->a_class . '" href="' . $this->canonical_url . '?page=' . $this->total_pages . $this->noHTML($this->url_params) . $this->anchor . '">&gt;&gt;</a></li>';
        $links .= '<li class="' . $this->li_class . '"><a class="' . $this->a_class . '" href="' . $this->canonical_url . '?page=' . $this->next_page . $this->noHTML($this->url_params) . $this->anchor . '">&gt;</a></li>';
      }
  ...
  public function setTotalRecords(int $total_records): void
  {
    if ($total_records < 0)
    {
      throw new \RangeException('Total records must be greater than or equal to zero: ' . $total_records);
    }
    else
    {
  ...
  {
    if (filter_var($canonical_url, FILTER_VALIDATE_URL) === false)
    {
  ...
  public function setUrlParams(array $url_params): void
  {
    ...
    $this->url_params = ($url_params !== []) ? '&' . preg_replace('/%5B[0-9]+%5D/simU', '%5B%5D', http_build_query($url_params)) . '&' : '';
  }
  ...
  public function setAnchor(string $anchor): void
  {
    if ($anchor[0] !== '#')
    {
      throw new \InvalidArgumentException('Anchor is invalid: ' . $anchor);
    }
    else
    {
      $this->anchor = $anchor;
  ...
  public function setCurrentPage(int $current_page): void
  {
    ...
    elseif ($this->total_pages > 0 && $current_page > $this->total_pages)
    {
  ...
  {
    $this->offset = ($this->total_records > 0) ? $this->db_offset + 1 : 0;
  }

  //

  private function setEndOffset(): void
  {
    $this->end_offset = ($this->offset > 0 && $this->current_page < $this->total_pages) ? $this->offset + $this->per_page - 1 : $this->total_records;
  }
  ...
  private function noHTML(string $str): string
  {
